<div class="page-breadcrumb">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url('home/aksi_tambah_pesan')?>">
                                <div class="card-body">
...
?>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label"><?= $nelson->nama_barang ?></label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="fname" name="<?= $nelson->nama_barang ?>" value="0" min="0">
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <input type="hidden" class="form-control" id="fname" name="meja" value="<?=$text?>">
                                    <input type="hidden" class="form-control" id="fname" name="kode" value="<?=$kode?>">
