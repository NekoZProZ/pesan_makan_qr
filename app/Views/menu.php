...
<?php if(session()->get('level')==1){
 ?>
                        ...
                        <!-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('home/absen') ?>" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Absen</span></a></li> -->
                        ...
                        <?php } ?>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('home/pesan') ?>" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Pesan</span></a></li>
